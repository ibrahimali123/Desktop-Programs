...
namespace Dr_Hany_billsPrice {
	...
	/// <summary>
	/// Summary for UoruFarma
	/// </summary>
	public ref class UoruFarma : public System::Windows::Forms::Form
	{
	private:
		Object^ f2;
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(UoruFarma::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &UoruFarma::button2_Click);
			// 
			// groupBox2
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &UoruFarma::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &UoruFarma::button3_Click);
			// 
			// groupBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &UoruFarma::button1_Click);
			// 
			// label1
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &UoruFarma::button6_Click);
			// 
			// button5
			// 
			this->button5->BackColor = System::Drawing::Color::Lime;
			this->button5->Location = System::Drawing::Point(12, 411);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(260, 32);
			this->button5->TabIndex = 8;
			this->button5->Text = L"Home";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &UoruFarma::button5_Click);
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->groupBox4->Location = System::Drawing::Point(287, 115);
			...
			this->ClientSize = System::Drawing::Size(710, 506);
			...
			this->Name = L"UoruFarma";
			this->Text = L"Euro Pharma Store";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 ofstream outfile1;
				 outfile1.open("uoru.txt", ios::app);
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ofstream readd;
			 readd.open("uoru.txt", ios::trunc);
			 MessageBox::Show("You Now Starting New month");
			 readd.close();
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
			 textBox3->Text = System::IO::File::ReadAllText("uoru.txt");
}
