...
namespace Dr_Hany_billsPrice {
	...
	/// <summary>
	/// Summary for FarmaOverseas
	/// </summary>
	public ref class FarmaOverseas : public System::Windows::Forms::Form
	{
	private:
		Object^ f2;
	public:
		FarmaOverseas(Object^ o)
		{
			f2 = o;
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(FarmaOverseas::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &FarmaOverseas::button1_Click);
			// 
			// label1
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &FarmaOverseas::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &FarmaOverseas::button3_Click);
			// 
			// groupBox3
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &FarmaOverseas::button2_Click);
			// 
			// pictureBox1
			// 
			...
			this->button6->Location = System::Drawing::Point(12, 463);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(260, 34);
			this->button6->TabIndex = 8;
			this->button6->Text = L"Exit";
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &FarmaOverseas::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &FarmaOverseas::button5_Click);
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->groupBox4->Location = System::Drawing::Point(290, 118);
			...
			this->Name = L"FarmaOverseas";
			this->Text = L"Pharma Overseas";
			this->Load += gcnew System::EventHandler(this, &FarmaOverseas::FarmaOverseas_Load);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 ofstream outfile1;
				 outfile1.open("farma.txt", ios::app);
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ofstream readd;
			 readd.open("farma.txt", ios::trunc);
			 MessageBox::Show("You Now Starting New month");
			 readd.close();
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
			 textBox3->Text = System::IO::File::ReadAllText("farma.txt");
}
private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
			 safe_cast<Form^>(f2)->Show();
			 this->Hide();
}
private: System::Void FarmaOverseas_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
