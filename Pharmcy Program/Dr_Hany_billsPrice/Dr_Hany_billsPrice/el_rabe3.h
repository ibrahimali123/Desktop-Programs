...
namespace Dr_Hany_billsPrice {
	...
	/// <summary>
	/// Summary for el_rabe3
	/// </summary>
	public ref class el_rabe3 : public System::Windows::Forms::Form
	{
	private:
		Object^ f2;
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(el_rabe3::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &el_rabe3::button2_Click);
			// 
			// groupBox2
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &el_rabe3::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &el_rabe3::button3_Click);
			// 
			// groupBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &el_rabe3::button1_Click);
			// 
			// label1
			// 
			...
			this->button6->Location = System::Drawing::Point(12, 458);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(260, 34);
			this->button6->TabIndex = 9;
			this->button6->Text = L"Exit";
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &el_rabe3::button6_Click);
			// 
			// button5
			// 
			this->button5->BackColor = System::Drawing::Color::Lime;
			this->button5->Location = System::Drawing::Point(12, 420);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(260, 32);
			this->button5->TabIndex = 8;
			this->button5->Text = L"Home";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &el_rabe3::button5_Click);
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->groupBox4->Location = System::Drawing::Point(287, 117);
			...
			this->ClientSize = System::Drawing::Size(700, 508);
			...
			this->Name = L"el_rabe3";
			this->Text = L"el_rabe3";
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ofstream readd;
			 readd.open("rabe3.txt", ios::trunc);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 ofstream outfile1;
			 outfile1.open("rabe3.txt", ios::app);
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
			 textBox3->Text = System::IO::File::ReadAllText("rabe3.txt");
}
