...
namespace Dr_Hany_billsPrice {
	...
	/// Summary for Bakeer
	/// </summary>
	public ref class Bakeer : public System::Windows::Forms::Form
	{
	private:
		Object^ f2;
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Bakeer::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &Bakeer::button2_Click);
			// 
			// groupBox2
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Bakeer::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Bakeer::button3_Click);
			// 
			// groupBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Bakeer::button1_Click);
			// 
			// label1
			// 
			...
			this->pictureBox1->Location = System::Drawing::Point(74, 261);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(198, 231);
			...
			this->button6->Location = System::Drawing::Point(12, 364);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(56, 128);
			this->button6->TabIndex = 9;
			this->button6->Text = L"Exit";
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &Bakeer::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Size = System::Drawing::Size(56, 97);
			this->button5->TabIndex = 8;
			this->button5->Text = L"Home";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Bakeer::button5_Click);
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->groupBox4->Location = System::Drawing::Point(287, 113);
			...
			this->ClientSize = System::Drawing::Size(702, 504);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 ofstream outfile1;
				 outfile1.open("bakeer.txt", ios::app);
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ofstream readd;
			 readd.open("bakeer.txt", ios::trunc);
			 MessageBox::Show("You Now Starting New month");
			 readd.close();
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
			 textBox3->Text = System::IO::File::ReadAllText("bakeer.txt");
}
